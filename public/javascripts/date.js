...
app.directive('datePicker', function ($timeout, $window) {
    return {
        ...
        link: function (scope, element, attrs, ctrl, transclude) {
            ...
            scope.days = [
                { "long":"Domingo","short":"Sun" },
                { "long":"Lunes","short":"Mon" },
                { "long":"Martes","short":"Tue" },
                { "long":"Miercoles","short":"Wed" },
                { "long":"Jueves","short":"Thu" },
                { "long":"Viernes","short":"Fri" },
                { "long":"Sábado","short":"Sat" },
            ];
